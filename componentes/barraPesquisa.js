...
const exibeProdutoPesquisado = (pesquisa)=>{
    ...
    if(pesquisa == ""){
        ...
        produtos.forEach(element => {
            const prodNome = element.nome.toLowerCase()
            const pesquisaNome = pesquisa.toLowerCase()
            if(prodNome.includes(pesquisaNome)){
...
export default exibeProdutoPesquisado